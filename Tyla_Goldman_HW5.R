...
#Due to variables, elevation and foliage height diversity index vectors being outside the radius of the ordination display 
...
#MOST IMPACTFUL VARIABLES 
#PC1 and PC2 were only used as according to the summary of PCA its seen that the two principal components 
#explain the bulk of variation across sites, cumulatively explaining 63% of variation while PC3 only explain about 19% of variation
...
#hiigh form influences high snowmelt 
...
#located at the lower region of the slope 
